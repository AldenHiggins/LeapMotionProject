...
public class SteamVR : System.IDisposable
{
	...
	static SteamVR CreateInstance()
	{
		...
		return new SteamVR(pHmd, pCompositor);
	}
	...
	public Compositor_TextureBounds[] textureBounds { get; private set; }
	...
	public static void SafeClearOverlay()
	{
		if (_instance != null && _instance.compositor != null)
			_instance.compositor.ClearOverlay();
	}
